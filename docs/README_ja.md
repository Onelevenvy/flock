...
>   - 🛠️ 高度なエージェント相互作用パターン
>   - 🔗 改善されたマルチエージェントコラボレーション機能
>
> ### �� 最新アップデート 2025/5/9
>
> - **エージェントノードサポート**: ワークフローにエージェントをシームレスに統合するための専用エージェントノードを追加！主な機能：
>   - 🧠 推論、計画、タスク実行が可能な自律型エージェントの作成
>   - 🔄 複数のエージェントタイプとアーキテクチャのサポート
>   - 🛠️ エージェントのメモリ、ツール、動作の簡単な設定
>   - 🔗 他のワークフローノードとシームレスに統合
>
> ### 🎉 最新アップデート 2025/3/10
>
