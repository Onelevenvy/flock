...
def create_provider(tool_provider: ToolProviderCreate):
...
def read_provider(tool_provider_id: int) -> Any:
    """
    Get provider by ID.
    """
    with session_getter() as session:
...
def read_provider_with_tools(tool_provider_id: int):
    with session_getter() as session:
...
def read_provider_list_with_tools():
    with session_getter() as session:
...
def update_provider(tool_provider_id: int, provider_update: ToolProviderUpdate) -> Any:
    """
    Update a provider.
    """
    with session_getter() as session:
...
async def delete_provider(tool_provider_id: int):
    """
    删除工具提供者
    """
    with session_getter() as session:
...
async def authenticate_provider(tool_provider_id: int):
    """
    对工具提供商进行鉴权或刷新工具列表
    """
    with session_getter() as session:
...
async def create_mcp_provider(mcp_provider: MCPProviderCreate):
    """
    创建 MCP 工具提供者并同步工具
    """
    with session_getter() as session:
...
async def update_mcp_provider(tool_provider_id: int, mcp_provider: MCPProviderUpdate):
    """
    更新 MCP 工具提供者并同步工具
    """
    with session_getter() as session:
...
async def test_mcp_connection(connection_test: MCPConnectionTest):
    """
    测试 MCP 连接
    """
    try:
...
async def sync_mcp_tools(tool_provider_id: int):
    """
    同步 MCP 工具
    """
    with session_getter() as session:
