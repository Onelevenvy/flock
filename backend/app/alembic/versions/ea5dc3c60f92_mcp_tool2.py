...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['user.id'], name=op.f('skill_owner_id_fkey')),
    sa.ForeignKeyConstraint(['resource_id'], ['resource.id'], name=op.f('skill_resource_id_fkey')),
