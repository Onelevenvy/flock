...
def upgrade():
    ...
    op.create_table('roleaccess',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('role_id', sa.Integer(), nullable=False),
    sa.Column('resource_id', sa.Integer(), nullable=False),
    sa.Column('action', sa.Enum('CREATE', 'READ', 'UPDATE', 'DELETE', 'EXECUTE', 'MANAGE', name='actiontype'), nullable=False),
    sa.Column('scope', sa.Enum('GLOBAL', 'TEAM', 'PERSONAL', name='accessscope'), nullable=False),
    sa.ForeignKeyConstraint(['resource_id'], ['resource.id'], ),
